...
No capítulo 5, são apresentados o módulo XBee adquirido pelo projeto para a implementação da rede, descrevendo suas especificações técnicas e os modos de operação disponíveis. 
